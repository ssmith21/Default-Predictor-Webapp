    ...
    >
        ...
        <b-breadcrumb>
            <b-breadcrumb-item href="https://github.com/ssmith21">
                <b-icon icon="github" href="https://github.com/ssmith21/ML-Portfolio/tree/main/CreditCardDefaultPredictor" scale="1.25" shift-v="1.25" aria-hidden="true"></b-icon>
                The Full IPNYB notebook for this project
            </b-breadcrumb-item>
        ...
        <div>
            <b-jumbotron 
            header="Credit Card Default Predictor" 
            lead="This app calculates the probability that you will default on your credit card next month."
            ...
            > 
                <p>For more information on how we calculate this data, read this article below.</p>
            </b-jumbotron>
        </div>

        <div class="p-2">
            <h1 v-if="APIResult.length <= 0" style="font-size:2.5rem">The chance of defaulting will appear here</h1>
            <h1 v-else-if="this.APIResult[0]===-1" style="font-size:2.5rem">Make sure to enter all the fields.</h1>
            <h1 v-else style="font-size:4rem">{{ this.APIResult[0] }} % </h1>

            <div v-if="this.APIResult[0] > 40.0">
                <h3 id="highrisk">You're at a very high risk of defaulting!</h3>
            </div>
            <div v-if="this.APIResult[0] <= 40.0 && this.APIResult[0] >= 25.0">
                <h3 id="medrisk">You're at a moderate risk of defaulting.</h3>
            </div>
            <div v-if="this.APIResult[0] < 25.0 && this.APIResult[0]>=0">
                <h3 id="lowrisk">You're at a very low risk of defaulting.</h3>
            </div>
        </div><br><br>

        <div class="p-2">
            <form @submit.stop.prevent><!-- TODO: control input values, add descriptions, add new page -->
                ...
                <div>
                    <b-container>
                        <b-row>
                            ...
                            <b-col>
                                <b-button pill variant="dark" v-b-toggle.collapse-1>More info</b-button>
                            </b-col>
                        </b-row>
                    </b-container>
                    <b-collapse id="collapse-1" class="mt-2">
                        <b-card>
                        <p class="card-text">
                            This app uses a deep neural network to estimate the chance of your credit card defaulting next month.
                            <br>The neural network was trained on thousands of credit card data, and
                            <br>these factors listed below might affect the chance of your credit card defaulting.
                        </p>
                        </b-card>
                    </b-collapse>
                </div>
                <div class="form-row" style="max-width:50rem">
                    <b-button disabled pill variant="outline-dark" class="col-3 pad2">Age</b-button>
                    <b-form-input :state="validateAge" class="form-control rounded-pill pad col-6" type="number" min=0 max=150 v-model.trim="defaultdata.AGE" placeholder="How old are you?"></b-form-input><br>
                    <b-form-invalid-feedback :state="validateAge"></b-form-invalid-feedback>
                    <b-form-valid-feedback :state="validateAge"></b-form-valid-feedback>
                    <div class="w-100"></div>
                    <b-button disabled pill variant="outline-dark" class="col-3 pad2">Gender</b-button>
                    <select :state="validateSEX" v-model.trim="defaultdata.SEX" class="form-control rounded-pill pad col-6">
                        <option value=1 selected>Male</option>
                        <option value=2 selected>Female</option>
                    </select>
                    <b-form-invalid-feedback :state="validateSEX"></b-form-invalid-feedback>
                    <b-form-valid-feedback :state="validateSEX"></b-form-valid-feedback>
                    <div class="w-100"></div>
                    <b-button disabled pill variant="outline-dark" class="col-3 pad2">Education</b-button>
                    <select :state="validateEDUCATION" v-model.trim="defaultdata.EDUCATION" class="form-control rounded-pill pad col-6">
                        <option value=1 selected>Grad school</option>
                        <option value=2 selected>University</option>
                        <option value=3 selected>Highschool</option>
                        <option value=4 selected>Other</option>
                    </select>
                    <b-form-invalid-feedback :state="validateEDUCATION"></b-form-invalid-feedback>
                    <b-form-valid-feedback :state="validateEDUCATION"></b-form-valid-feedback>
                    <div class="w-100"></div>
                    <b-button disabled pill variant="outline-dark" class="col-3 pad2">Marrital status</b-button>
                    <select  :state="validateMARRIAGE" v-model.trim="defaultdata.MARRIAGE" class="form-control rounded-pill pad col-6">
                        <option value=1 selected>Married</option>
                        <option value=2 selected>Single</option>
                        <option value=3 selected>Other</option>
                    </select>
                    <b-form-invalid-feedback :state="validateMARRIAGE"></b-form-invalid-feedback>
                    <b-form-valid-feedback :state="validateMARRIAGE"></b-form-valid-feedback>
                    <div class="w-100"></div>
                    <b-button disabled pill variant="outline-dark" class="col-3 pad2">Credit card balance limit</b-button>
                    <b-form-input  :state="validateLIMIT_BAL" class="form-control rounded-pill pad col-6" type="number" v-model.trim="defaultdata.LIMIT_BAL" placeholder="Your credit card limit in dollars (example: 15000)"></b-form-input>
                    <b-form-invalid-feedback :state="validateLIMIT_BAL"></b-form-invalid-feedback>
                    <b-form-valid-feedback :state="validateLIMIT_BAL"></b-form-valid-feedback>
                </div><br><br>
                ...
                <div>
                    <b-container>
                        <b-row>
                            <b-col>
                                <h3>Pay punctuality</h3>
                            </b-col>
                            <b-col>
                                <b-button pill variant="dark" v-b-toggle.collapse-2>What's this?</b-button>
                            </b-col>
                        </b-row>
                    </b-container>
                    <b-collapse id="collapse-2" class="mt-2">
                        <b-card>
                        <h4 class="card-text">
                            <b>It's the history of your past payment statuses.</b>
                        </h4>
                        <p class="card-text">
                            Each cell is the status for a specific month.
                            <br>The 1st cell is for your status 1 month ago, the 2nd cell for 2 months ago etc.
                            <br>A value of -1 means paid duly, a value of 0 is payment on that month,
                            <br>a value of 1 means 1 month delayed payment, 2 means 2 months delayed payment etc.
                        </p>
                        </b-card>
                    </b-collapse>
                </div>
                <div class="form-row" style="max-width:50rem">
                    <b-form-input :state="validatePAY_0" class="form-control rounded-pill pad col-md-3 col-sm-6" type="number" v-model.trim="defaultdata.PAY_0" placeholder="1 month ago"></b-form-input>
                    <b-form-input :state="validatePAY_1"  class="form-control rounded-pill pad col-md-3 col-sm-6" type="number" v-model.trim="defaultdata.PAY_1" placeholder="2 months ago"></b-form-input>
                    <b-form-input :state="validatePAY_2"  class="form-control rounded-pill pad col-md-3 col-sm-6" type="number" v-model.trim="defaultdata.PAY_2" placeholder="3 months ago"></b-form-input>
                    <b-form-input :state="validatePAY_3"  class="form-control rounded-pill pad col-md-3 col-sm-6" type="number" v-model.trim="defaultdata.PAY_3" placeholder="4 months ago"></b-form-input>
                    <b-form-input :state="validatePAY_4"  class="form-control rounded-pill pad col-md-3 col-sm-6" type="number" v-model.trim="defaultdata.PAY_4" placeholder="5 months ago"></b-form-input> 
                    <b-form-input :state="validatePAY_5"  class="form-control rounded-pill pad col-md-3 col-sm-6" type="number" v-model.trim="defaultdata.PAY_5" placeholder="6 months ago"></b-form-input>
                    <b-form-invalid-feedback :state="validatePAY_0"></b-form-invalid-feedback>
                    <b-form-valid-feedback :state="validatePAY_0"></b-form-valid-feedback>                  
                    <b-form-invalid-feedback :state="validatePAY_1"></b-form-invalid-feedback>
                    <b-form-valid-feedback :state="validatePAY_1"></b-form-valid-feedback>
                    <b-form-invalid-feedback :state="validatePAY_2"></b-form-invalid-feedback>
                    <b-form-valid-feedback :state="validatePAY_2"></b-form-valid-feedback>
                    <b-form-invalid-feedback :state="validatePAY_3"></b-form-invalid-feedback>
                    <b-form-valid-feedback :state="validatePAY_3"></b-form-valid-feedback>
                    <b-form-invalid-feedback :state="validatePAY_4"></b-form-invalid-feedback>
                    <b-form-valid-feedback :state="validatePAY_4"></b-form-valid-feedback>
                    <b-form-invalid-feedback :state="validatePAY_5"></b-form-invalid-feedback>
                    <b-form-valid-feedback :state="validatePAY_5"></b-form-valid-feedback>
                </div><br><br>
                ...
                <div>
                    <b-container>
                        <b-row>
                            ...
                            <b-col>
                                <b-button pill variant="dark" v-b-toggle.collapse-3>What's this?</b-button>
                            </b-col>
                        </b-row>
                    </b-container>
                    <b-collapse id="collapse-3" class="mt-2">
                        <b-card>
                        <h4 class="card-text">
                            <b>It's your credit card bill each month.</b>
                        </h4>
                        <p class="card-text">
                            Each cell is the bill for a specific month in dollars.
                            <br>The 1st cell is your bill for 1 month ago, the 2nd cell for 2 months ago etc.
                        </p>
                        </b-card>
                    </b-collapse>
                </div>
                <div class="form-row" style="max-width:50rem">
                    <b-form-input :state="validateBILL_AMT1" class="form-control rounded-pill pad col-md-3 col-sm-6" type="number" v-model.trim="defaultdata.BILL_AMT1" placeholder="1 month ago"></b-form-input>
                    <b-form-input :state="validateBILL_AMT2" class="form-control rounded-pill pad col-md-3 col-sm-6" type="number" v-model.trim="defaultdata.BILL_AMT2" placeholder="2 months ago"></b-form-input>
                    <b-form-input :state="validateBILL_AMT3" class="form-control rounded-pill pad col-md-3 col-sm-6" type="number" v-model.trim="defaultdata.BILL_AMT3" placeholder="3 months ago"></b-form-input>
                    <b-form-input :state="validateBILL_AMT4" class="form-control rounded-pill pad col-md-3 col-sm-6" type="number" v-model.trim="defaultdata.BILL_AMT4" placeholder="4 months ago"></b-form-input>
                    <b-form-input :state="validateBILL_AMT5" class="form-control rounded-pill pad col-md-3 col-sm-6" type="number" v-model.trim="defaultdata.BILL_AMT5" placeholder="5 months ago"></b-form-input>
                    <b-form-input :state="validateBILL_AMT6" class="form-control rounded-pill pad col-md-3 col-sm-6" type="number" v-model.trim="defaultdata.BILL_AMT6" placeholder="6 months ago"></b-form-input>
                    <b-form-invalid-feedback :state="validateBILL_AMT1"></b-form-invalid-feedback>
                    <b-form-valid-feedback :state="validateBILL_AMT1"></b-form-valid-feedback>
                    <b-form-invalid-feedback :state="validateBILL_AMT2"></b-form-invalid-feedback>
                    <b-form-valid-feedback :state="validateBILL_AMT2"></b-form-valid-feedback>    
                    <b-form-invalid-feedback :state="validateBILL_AMT3"></b-form-invalid-feedback>
                    <b-form-valid-feedback :state="validateBILL_AMT3"></b-form-valid-feedback>    
                    <b-form-invalid-feedback :state="validateBILL_AMT4"></b-form-invalid-feedback>
                    <b-form-valid-feedback :state="validateBILL_AMT4"></b-form-valid-feedback>    
                    <b-form-invalid-feedback :state="validateBILL_AMT5"></b-form-invalid-feedback>
                    <b-form-valid-feedback :state="validateBILL_AMT5"></b-form-valid-feedback>    
                    <b-form-invalid-feedback :state="validateBILL_AMT6"></b-form-invalid-feedback>
                    <b-form-valid-feedback :state="validateBILL_AMT6"></b-form-valid-feedback>    
                </div><br><br>
                ...
                <div>
                    <b-container>
                        <b-row>
                            ...
                            <b-col>
                                <b-button pill variant="dark" v-b-toggle.collapse-4>What's this?</b-button>
                            </b-col>
                        </b-row>
                    </b-container>
                    <b-collapse id="collapse-4" class="mt-2">
                        <b-card>
                        <h4 class="card-text">
                            <b>It's your how much of your credit card bill you paid back each month.</b>
                        </h4>
                        <p class="card-text">
                            Each cell is the bill for a specific month in dollars.
                            <br>The 1st cell is your payment for 1 month ago, the 2nd cell for 2 months ago etc.
                        </p>
                        </b-card>
                    </b-collapse>
                </div>
                <div class="form-row" style="max-width:50rem">
                    <b-form-input :state="validatePAY_AMT1" class="form-control rounded-pill pad col-md-3 col-sm-6" type="number" v-model.trim="defaultdata.PAY_AMT1" placeholder="1 month ago"></b-form-input>
                    <b-form-input :state="validatePAY_AMT2" class="form-control rounded-pill pad col-md-3 col-sm-6" type="number" v-model.trim="defaultdata.PAY_AMT2" placeholder="2 months ago"></b-form-input>
                    <b-form-input :state="validatePAY_AMT3" class="form-control rounded-pill pad col-md-3 col-sm-6" type="number" v-model.trim="defaultdata.PAY_AMT3" placeholder="3 months ago"></b-form-input>
                    <b-form-input :state="validatePAY_AMT4" class="form-control rounded-pill pad col-md-3 col-sm-6" type="number" v-model.trim="defaultdata.PAY_AMT4" placeholder="4 months ago"></b-form-input>
                    <b-form-input :state="validatePAY_AMT5" class="form-control rounded-pill pad col-md-3 col-sm-6" type="number" v-model.trim="defaultdata.PAY_AMT5" placeholder="5 months ago"></b-form-input>
                    <b-form-input :state="validatePAY_AMT6" class="form-control rounded-pill pad col-md-3 col-sm-6" type="number" v-model.trim="defaultdata.PAY_AMT6" placeholder="6 months ago"></b-form-input>
                    <b-form-invalid-feedback :state="validatePAY_AMT1"></b-form-invalid-feedback>
                    <b-form-valid-feedback :state="validatePAY_AMT1"></b-form-valid-feedback>    
                    <b-form-invalid-feedback :state="validatePAY_AMT2"></b-form-invalid-feedback>
                    <b-form-valid-feedback :state="validatePAY_AMT2"></b-form-valid-feedback>    
                    <b-form-invalid-feedback :state="validatePAY_AMT3"></b-form-invalid-feedback>
                    <b-form-valid-feedback :state="validatePAY_AMT3"></b-form-valid-feedback>    
                    <b-form-invalid-feedback :state="validatePAY_AMT4"></b-form-invalid-feedback>
                    <b-form-valid-feedback :state="validatePAY_AMT4"></b-form-valid-feedback>    
                    <b-form-invalid-feedback :state="validatePAY_AMT5"></b-form-invalid-feedback>
                    <b-form-valid-feedback :state="validatePAY_AMT5"></b-form-valid-feedback>    
                    <b-form-invalid-feedback :state="validatePAY_AMT6"></b-form-invalid-feedback>
                    <b-form-valid-feedback :state="validatePAY_AMT6"></b-form-valid-feedback>  
                </div><br>

                <b-button block  @click="predict" pill variant="dark">Submit</b-button>
                <br><br><br>
                ...
                <div class="accordion" role="tablist">
                    ...
                    <b-card no-body class="mb-1" style="width: 57.5rem;">
                        ...
                        <b-collapse id="accordion-5" accordion="my-accordion" role="tabpanel">
                            <b-card-body><b-card-text>
                                <h2>This is the predicting model for this webapp!</h2>
        ...
        <div style="max-width: 60rem;">
            ...
            >
                ...
                <hr class="my-4">
                <b>Gender, Highschool education, age, marrital status.</b><br>
...
export default {
    ...
    computed: {
        validateLIMIT_BAL(){if(!this.defaultdata.LIMIT_BAL || this.defaultdata.LIMIT_BAL<0){return false;} return true;},
        validateSEX(){if(!this.defaultdata.SEX){return false;} return true;},
        validateEDUCATION(){if(!this.defaultdata.EDUCATION){return false;} return true;},
        validateMARRIAGE(){if(!this.defaultdata.MARRIAGE){return false;} return true;},
        validateAge(){if(!this.defaultdata.AGE || this.defaultdata.AGE<0){return false;} return true;},
        validatePAY_0(){if(!this.defaultdata.PAY_0){return false;} return true;},
        validatePAY_1(){if(!this.defaultdata.PAY_1){return false;} return true;},
        validatePAY_2(){if(!this.defaultdata.PAY_2){return false;} return true;},
        validatePAY_3(){if(!this.defaultdata.PAY_3){return false;} return true;},
        validatePAY_4(){if(!this.defaultdata.PAY_4){return false;} return true;},
        validatePAY_5(){if(!this.defaultdata.PAY_5){return false;} return true;},
        validateBILL_AMT1(){if(!this.defaultdata.BILL_AMT1){return false;} return true;},
        validateBILL_AMT2(){if(!this.defaultdata.BILL_AMT2){return false;} return true;},
        validateBILL_AMT3(){if(!this.defaultdata.BILL_AMT3){return false;} return true;},
        validateBILL_AMT4(){if(!this.defaultdata.BILL_AMT4){return false;} return true;},
        validateBILL_AMT5(){if(!this.defaultdata.BILL_AMT5){return false;} return true;},
        validateBILL_AMT6(){if(!this.defaultdata.BILL_AMT6){return false;} return true;},
        validatePAY_AMT1(){if(!this.defaultdata.PAY_AMT1){return false;} return true;},
        validatePAY_AMT2(){if(!this.defaultdata.PAY_AMT2){return false;} return true;},
        validatePAY_AMT3(){if(!this.defaultdata.PAY_AMT3){return false;} return true;},
        validatePAY_AMT4(){if(!this.defaultdata.PAY_AMT4){return false;} return true;},
        validatePAY_AMT5(){if(!this.defaultdata.PAY_AMT5){return false;} return true;},
        validatePAY_AMT6(){if(!this.defaultdata.PAY_AMT6){return false;} return true;},
    },
    methods: {
        predict() {
            getAPI.get("/", {
                params: {
                    limitbal: this.defaultdata.LIMIT_BAL,
                    gender: this.defaultdata.SEX,
                    education: this.defaultdata.EDUCATION,
                    marriage: this.defaultdata.MARRIAGE,
                    age: this.defaultdata.AGE,
                    pay0: this.defaultdata.PAY_0,
                    pay1: this.defaultdata.PAY_1,
                    pay2: this.defaultdata.PAY_2,
                    pay3: this.defaultdata.PAY_3,
                    pay4: this.defaultdata.PAY_4,
                    pay5: this.defaultdata.PAY_5,
                    billamt1: this.defaultdata.BILL_AMT1,
                    billamt2: this.defaultdata.BILL_AMT2,
                    billamt3: this.defaultdata.BILL_AMT3,
                    billamt4: this.defaultdata.BILL_AMT4,
                    billamt5: this.defaultdata.BILL_AMT5,
                    billamt6: this.defaultdata.BILL_AMT6,
                    payamt1: this.defaultdata.PAY_AMT1,
                    payamt2: this.defaultdata.PAY_AMT2,
                    payamt3: this.defaultdata.PAY_AMT3,
                    payamt4: this.defaultdata.PAY_AMT4,
                    payamt5: this.defaultdata.PAY_AMT5,
                    payamt6: this.defaultdata.PAY_AMT6
                }
            }).then(response => {
